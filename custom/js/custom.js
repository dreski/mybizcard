...
function selectVideoFile(elementid){
  ...
  $(`.${elementid}`).change(function() {
      ...
      if (this.files && this.files[0]) {
          ...
          $(`#${elementid}`).attr('src', '/assets/cinema.png');

          $(`#section_${elementid}`).attr('src', '/assets/cinema.png');
      }
  });
}
                ...
                if(img.width === 512 && img.height === 512){
                    ...
                    if (this.files && this.files[0]&& (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")) {
                        ...
                        reader.onload = function (e) {
                            ...
                            $(`#section_${elementid}`).attr('src', e.target.result);
                            $(`#${elementid}_preview`).attr('src', e.target.result);
                            $(`.${elementid}_previews`).attr('src', e.target.result);
                        }
                        reader.readAsDataURL(this.files[0]);
                    }else{
                    ...
                    toastrs('Success', 'Image size must be 512x512');
                }                
            }
        }else{
            var url = this.value;
